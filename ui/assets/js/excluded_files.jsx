    ...
    render: function () {
        ...
        this.props.repos.forEach(function (repo) {
            repos.push(
                <RepoButton
                    repo={repo}
                    onRepoClick={_this.props.onRepoClick}
                    currentRepo={_this.props.repo}
                />,
            );
        });

        return <div id="repolist">{repos}</div>;
    },
});
        ...
        return (
            <div id="excluded_container">
                ...
                <div id="excluded_files" className="table-container">
                    <RepoList
                        repos={Object.keys(this.state.repos)}
...
React.renderComponent(<FilterableExcludedFiles />, document.getElementById("root"));
