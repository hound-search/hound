...
const (
	defaultRef             = "master"
	autoGeneratedAttribute = "linguist-generated"
)
...
func (g *GitDriver) AutoGeneratedFiles(dir string) []string {
	...
	lsFilesCmd.Dir = dir
	lsFilesStdout, err := lsFilesCmd.StdoutPipe()
	if err != nil {
	...
	checkAttrCmd := exec.Command("git", "check-attr", "--stdin", "-z", autoGeneratedAttribute)
	checkAttrCmd.Dir = dir
	checkAttrCmd.Stdin = lsFilesStdout

	out, err := checkAttrCmd.Output()
	if err != nil {
