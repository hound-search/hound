...
// prepareGitEnv loads existing environment variables and adds GIT_LFS_SKIP_SMUDGE=1
...
func (g *GitDriver) AutoGeneratedFiles(dir string) []string {
	...
	attributesCmd.Env = prepareGitEnv()
